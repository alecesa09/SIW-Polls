...
INSERT INTO sondaggio (id, titolo, descrizione, immagine, data_creazione, data_scadenza_voto, visibilita, codice_accesso, utente_id) VALUES (2, 'Framework Frontend', 'Il panorama Frontend e in continua evoluzione. Quale libreria preferisci usare nei tuoi progetti?', 'react.png', '2026-07-15', '2026-11-30', 'PUBBLICO', 'FRONT26', 4);
INSERT INTO sondaggio (id, titolo, descrizione, immagine, data_creazione, data_scadenza_voto, visibilita, codice_accesso, utente_id) VALUES (3, 'Database Relazionali vs NoSQL', 'Raccolta dati sulle preferenze dei DBMS per i nuovi microservizi.', 'dbms.jpg', '2026-07-10', '2026-10-31', 'PUBBLICO', 'DB2026', 4);
INSERT INTO sondaggio (id, titolo, descrizione, immagine, data_creazione, data_scadenza_voto, visibilita, codice_accesso, utente_id) VALUES (4, 'Cloud Providers', 'Dove preferisci fare il deploy delle tue applicazioni enterprise?', 'cloudProvider.png', '2026-07-18', '2026-3-15', 'PUBBLICO', 'CLOUD26', 4);
INSERT INTO sondaggio (id, titolo, descrizione, immagine, data_creazione, data_scadenza_voto, visibilita, codice_accesso, utente_id) VALUES (5, 'Eventi Tech Italia', 'Sondaggio riservato per l organizzazione della trasferta aziendale.', 'TechEvent.jpg', '2026-07-19', '2026-09-01', 'PUBBLICO', 'EVITA26', 4);
